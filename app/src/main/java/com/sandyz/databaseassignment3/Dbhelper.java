...
public beans getAllEmployee()throws SQLException{
    ...
    if (cursor.moveToNext()){
        ...
        String name = cursor.getString(cursor.getColumnIndex(COLOUMN_ONE));
        String age = cursor.getString(cursor.getColumnIndex(COLOUMN_TWO));
        byte[] blob = cursor.getBlob(cursor.getColumnIndex(COLOUMN_THREE));
        cursor.close();
